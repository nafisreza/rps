...
export default function TeacherCourseResultsPage({
  ...
  async function saveMarks(submit = false) {
    ...
    if (submit) {
      ...
      if (!allFilled) {
        sonnerToast.error("Please enter all marks for all students before submitting.");
        return;
      }
    }
    const res = await fetch(`/api/teacher/courses/${courseId}/results`, {
  ...
  return (
    <div className="mx-auto p-6">
      ...
      <span className="text-gray-600 text-xs mb-4">Enter marks of the students throughout the semester. The grade will be calculated automatically.</span>
