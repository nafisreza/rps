    ...
    <main className="flex-1 p-8">
      ...
      <div className="flex justify-between mb-8">
        ...
        <div className="flex items-center gap-4 mb-4">
          ...
          <Select
            value={filterTeacher || "all"}
            onValueChange={(v) => setFilterTeacher(v === "all" ? "" : v)}
          >
            <SelectTrigger className="w-[160px]">
          ...
          <Select
            value={filterCredit || "all"}
            onValueChange={(v) => setFilterCredit(v === "all" ? "" : v)}
          >
            <SelectTrigger className="w-[120px]">
            ...
            >
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setEditForm({ ...editForm, credit: Number(e.target.value) })
                  }
                  required
                />
              </div>
              ...
              <div>
                ...
                <Select
                  value={
                    editForm.teacherId === "" ? "none" : editForm.teacherId
                  }
                  onValueChange={(value) =>
                    setEditForm({
                      ...editForm,
